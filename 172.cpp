...
int main()
{
    ...
    //13. Repeat 10,11,12 using a vector rather than an array.
    //1310. Allocate a vector of ten ints, and assign its address to a variable p2.
    vector<int> v10 = { 1, 2, 4, 8, 16, 32, 64, 128, 256, 512 };
    p1 = &v10[0];

    //1311. Allocate a vector of ten ints, and assign its address to a variable p2.
    vector<int> v11(10);
    p2 = &v11[0];

    //1312. Copy the values from the vector pointed to by p1 into the vector pointed to by p2.
    v11 = v10;
